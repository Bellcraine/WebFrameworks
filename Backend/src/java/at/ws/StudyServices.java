...
public class StudyServices {
     ...
     * output: person object OR null if login is incorrect
     */
     ...
     * output: course ArrayList --- only students have grade & lecturer
     */
     ...
     * input: course.coursePk, person.personPk
     * output: true / false (gives also true, if person-course combination does not exist in membership table)
     */
     ...
     *        case 1  no primary key / with password -> person will be created (password required!)
     *        case 2  with primary key / no password -> person will be updated (password stays the same)
     *        case 3  with primary key / with password -> person will be updated completely
     * output: true / false
     */
     ...
     * loadMembershipData (previous: studentGetGrade)
     * input: course.coursePk, person.personPk
